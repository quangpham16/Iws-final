...
import {
    ...
    ArrowUpDown, ArrowUp, ArrowDown, X, Filter, Calendar
} from 'lucide-react';
...
function SortHeader({ label, field, sortField, sortDir, onSort }) {
    ...
    return (
        <th
            className="px-6 py-5 text-left text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 cursor-pointer select-none whitespace-nowrap group"
...
export default function TransactionsPage() {
    ...
    // Unique category list from existing transactions
        ...
        <div className="space-y-8 max-w-[1600px] mx-auto w-full animate-in fade-in duration-700">
                            ...
                            {paginated.length === 0 ? (
                                ...
                                return (
                                    <tr key={t.id} className="hover:bg-gray-50/60 transition-colors group">
                                        ...
                                        <td className="px-6 py-5">
                                            {t.category ? (
                                                <span className="text-xs font-black uppercase tracking-widest text-gray-500 bg-gray-100 px-3 py-1 rounded-xl">
                                                    {t.category}
                                                </span>
                                            ) : (
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-2xl text-sm font-black transition-all ${
                                        ...
                                        : 'border-2 border-gray-200 text-gray-500 hover:border-[#106E4E] hover:text-[#106E4E]'
                                    }`}
                                >
                                    {p}
                                </button>
            ...
            {showAdd && (
                <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-md z-50 flex items-center justify-center p-6 animate-in fade-in duration-300">
                    <div className="bg-white w-full max-w-2xl rounded-[3rem] shadow-2xl animate-in slide-in-from-bottom-8 duration-500 overflow-hidden">
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-4 rounded-[1.25rem] text-sm font-black transition-all ${
                                            ...
                                            ? t === 'EXPENSE'
                                                ...
                                                : 'bg-white text-[#106E4E] shadow-sm'
